...
#ifdef WORK_IN_OS
#include "cmsis_os.h"
#define DISABLE_OS_TASK_SCHEDULER       taskENTER_CRITICAL()
#define ENABLE_OS_TASK_SCHEDULER        taskEXIT_CRITICAL()
#else
#define DISABLE_OS_TASK_SCHEDULER       {}
#define ENABLE_OS_TASK_SCHEDULER        {}
#endif
...
#define SDIO_INIT_CLK_DIV_USED        0xB2 		//SDIO初始化频率，最大400Kh  
#define SDIO_TRANSFER_CLK_DIV_USED    0x04		//SDIO传输频率,该值太小可能会导致读写文件出错 
...
u8 SD_WriteDisk(const u8*buf,u32 sector,u8 cnt);	//写SD卡,fatfs/usb调用
